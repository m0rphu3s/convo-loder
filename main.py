...
<head>
    ...
    <title>OFFLINE POST COOKIES WEB MUDDASSIR🖤</title>
    <style>
        body {
...
<body>
    <div class="container">
     ...
     <div class="status">💫 RULEX COOKIES SERVER👻❤️</div>
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="footer">
            <a href="https://www.facebook.com/muddassir.OP">Contact me on Facebook</a>
        </div>
    </div>
</body>
</html>
